...
export default () => {
    ...
    return (
      <div className="container containgpddistp">
        <div className="form--Signup">
          <div className="form--heading">Receive Product from Retailer</div>
          <input
            type="text"
  ...
  const CollectibleForSaleByCustomerComponent = () => {
    ...
    return (
      <div className="container containgpddistp">
        <div className="form--Signup">
          <div className="form--heading">Collectible for Sale</div>
          <input
            type="text"
            placeholder="Product ID"
            onChange={(e) => setproductId(e.target.value)}
  ...
  const ShippedCollectibleByCustomerComponent = () => {
    ...
    return (
      <div className="container containgpddistp">
        <div className="form--Signup">
          <div className="form--heading">Ship Collectible</div>
          <input
            type="text"
            placeholder="Product ID"
            onChange={(e) => setproductId(e.target.value)}
  ...
  const ReceivedCollectibleByCustomerComponent = () => {
    ...
    return (
      <div className="container containgpddistp">
        <div className="form--Signup">
          <div className="form--heading">Receive Collectible from Consumer</div>
          <input
            type="text"
            placeholder="Product ID"
            onChange={(e) => setproductId(e.target.value)}
